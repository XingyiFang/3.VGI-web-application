...
var _7fe=$(_7fc).combo("panel");
data=opts.loadFilter.call(_7fc,data);
$.data(_7fc,"combobox").data=data;
var _7ff=$(_7fc).combobox("getValues");
_7fe.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_7fe);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_7fc,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
function _800(_801,url,_802,_803){
var opts=$.data(_801,"combobox").options;
if(url){
opts.url=url;
}
_802=_802||{};
if(opts.onBeforeLoad.call(_801,_802)==false){
return;
}
opts.loader.call(_801,_802,function(data){
_7fb(_801,data,_803);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _804(_805,q){
var opts=$.data(_805,"combobox").options;
if(opts.multiple&&!q){
_7f0(_805,[],true);
}else{
_7f0(_805,[q],true);
...
if(opts.mode=="remote"){
_800(_805,null,{q:q},true);
}else{
var _806=$(_805).combo("panel");
_806.find("div.combobox-item").hide();
var data=$.data(_805,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_805,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_806.find("div.combobox-item[value=\""+v+"\"]");
item.show();
if(s==q){
_7f0(_805,[v],true);
...
function _807(_808){
var t=$(_808);
var _809=t.combobox("panel");
var opts=t.combobox("options");
var data=t.combobox("getData");
var item=_809.children("div.combobox-item-hover");
if(!item.length){
item=_809.children("div.combobox-item-selected");
}
if(!item.length){
return;
}
...
var vv=[];
var _80a=t.combobox("getValues");
for(var i=0;i<_80a.length;i++){
if(_7e4(data,opts.valueField,_80a[i])){
vv.push(_80a[i]);
}
}
...
function _80b(_80c){
var opts=$.data(_80c,"combobox").options;
$(_80c).addClass("combobox-f");
$(_80c).combo($.extend({},opts,{onShowPanel:function(){
$(_80c).combo("panel").find("div.combobox-item").show();
_7e6(_80c,$(_80c).combobox("getValue"));
opts.onShowPanel.call(_80c);
}}));
$(_80c).combo("panel").unbind().bind("mouseover",function(e){
...
_7ec(_80c,_80d);
$(_80c).combo("hidePanel");
}
e.stopPropagation();
});
};
$.fn.combobox=function(_80e,_80f){
if(typeof _80e=="string"){
var _810=$.fn.combobox.methods[_80e];
if(_810){
return _810(this,_80f);
}else{
return this.combo(_80e,_80f);
}
}
_80e=_80e||{};
return this.each(function(){
var _811=$.data(this,"combobox");
if(_811){
$.extend(_811.options,_80e);
_80b(this);
}else{
_811=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_80e)});
_80b(this);
...
if(_811.options.data){
_7fb(this,_811.options.data);
}
_800(this);
});
};
$.fn.combobox.methods={options:function(jq){
var _812=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{originalValue:_812.originalValue,disabled:_812.disabled,readonly:_812.readonly});
},getData:function(jq){
return $.data(jq[0],"combobox").data;
},setValues:function(jq,_813){
return jq.each(function(){
_7f0(this,_813);
});
...
return jq.each(function(){
$(this).combo("clear");
var _815=$(this).combo("panel");
_815.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_816){
return jq.each(function(){
_7ec(this,_816);
});
},unselect:function(jq,_817){
return jq.each(function(){
_7f1(this,_817);
});
}};
$.fn.combobox.parseOptions=function(_818){
var t=$(_818);
return $.extend({},$.fn.combo.parseOptions(_818),$.parser.parseOptions(_818,["valueField","textField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_819){
var data=[];
var opts=$(_819).combobox("options");
$(_819).children("option").each(function(){
var item={};
...
},loader:function(_81a,_81b,_81c){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_81a,dataType:"json",success:function(data){
_81b(data);
},error:function(){
_81c.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},onBeforeLoad:function(_81d){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_81e){
},onUnselect:function(_81f){
}});
})(jQuery);
(function($){
function _820(_821){
...
$(_821).addClass("combotree-f");
$(_821).combo(opts);
var _822=$(_821).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_822);
$.data(_821,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _823=$(_821).combotree("getValues");
if(opts.multiple){
var _824=tree.tree("getChecked");
...
$(_821).combotree("setValues",_823);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_826(_821);
$(_821).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_825){
_826(_821);
opts.onCheck.call(this,node,_825);
}}));
};
function _826(_827){
var opts=$.data(_827,"combotree").options;
var tree=$.data(_827,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _828=tree.tree("getChecked");
...
$(_827).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _829(_82a,_82b){
var opts=$.data(_82a,"combotree").options;
var tree=$.data(_82a,"combotree").tree;
...
$(_82a).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_82c,_82d){
if(typeof _82c=="string"){
var _82e=$.fn.combotree.methods[_82c];
if(_82e){
return _82e(this,_82d);
}else{
return this.combo(_82c,_82d);
}
}
_82c=_82c||{};
return this.each(function(){
var _82f=$.data(this,"combotree");
if(_82f){
$.extend(_82f.options,_82c);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_82c)});
}
_820(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _830=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{originalValue:_830.originalValue,disabled:_830.disabled,readonly:_830.readonly});
},tree:function(jq){
...
},setValues:function(jq,_831){
return jq.each(function(){
_829(this,_831);
});
},setValue:function(jq,_832){
return jq.each(function(){
_829(this,[_832]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_833){
return $.extend({},$.fn.combo.parseOptions(_833),$.fn.tree.parseOptions(_833));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _834(_835){
var _836=$.data(_835,"combogrid");
var opts=_836.options;
var grid=_836.grid;
$(_835).addClass("combogrid-f").combo(opts);
var _837=$(_835).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_837);
_836.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _838=$(_835).combo("getValues");
var _839=opts.onSelect;
opts.onSelect=function(){
};
_843(_835,_838,_836.remainText);
opts.onSelect=_839;
opts.onLoadSuccess.apply(_835,arguments);
},onClickRow:_83a,onSelect:function(_83b,row){
_83c();
opts.onSelect.call(this,_83b,row);
},onUnselect:function(_83d,row){
_83c();
opts.onUnselect.call(this,_83d,row);
},onSelectAll:function(rows){
_83c();
...
function _83a(_83e,row){
_836.remainText=false;
_83c();
if(!opts.multiple){
$(_835).combo("hidePanel");
}
opts.onClickRow.call(this,_83e,row);
};
function _83c(){
...
if(!opts.multiple){
$(_835).combo("setValues",(vv.length?vv:[""]));
}else{
$(_835).combo("setValues",vv);
}
if(!_836.remainText){
$(_835).combo("setText",ss.join(opts.separator));
}
};
};
function nav(_83f,dir){
var _840=$.data(_83f,"combogrid");
var opts=_840.options;
var grid=_840.grid;
var _841=grid.datagrid("getRows").length;
if(!_841){
return;
}
...
var _842;
if(!tr.length){
_842=(dir=="next"?0:_841-1);
}else{
var _842=parseInt(tr.attr("datagrid-row-index"));
_842+=(dir=="next"?1:-1);
if(_842<0){
_842=_841-1;
}
...
grid.datagrid("highlightRow",_842);
if(opts.selectOnNavigation){
_840.remainText=false;
grid.datagrid("selectRow",_842);
}
};
function _843(_844,_845,_846){
var _847=$.data(_844,"combogrid");
var opts=_847.options;
var grid=_847.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _848=$(_844).combo("getValues");
var _849=$(_844).combo("options");
var _84a=_849.onChange;
_849.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_845.length;i++){
var _84b=grid.datagrid("getRowIndex",_845[i]);
if(_84b>=0){
grid.datagrid("selectRow",_84b);
ss.push(rows[_84b][opts.textField]);
}else{
ss.push(_845[i]);
}
}
$(_844).combo("setValues",_848);
_849.onChange=_84a;
$(_844).combo("setValues",_845);
if(!_846){
var s=ss.join(opts.separator);
if($(_844).combo("getText")!=s){
$(_844).combo("setText",s);
}
}
};
function _84c(_84d,q){
var _84e=$.data(_84d,"combogrid");
var opts=_84e.options;
var grid=_84e.grid;
_84e.remainText=true;
if(opts.multiple&&!q){
_843(_84d,[],true);
}else{
_843(_84d,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_84d,q,rows[i])){
grid.datagrid("clearSelections");
...
_851.remainText=false;
var _852=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_852);
}else{
grid.datagrid("selectRow",_852);
}
}else{
grid.datagrid("selectRow",_852);
$(_850).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_853,_854){
if(typeof _853=="string"){
var _855=$.fn.combogrid.methods[_853];
if(_855){
return _855(this,_854);
}else{
return $.fn.combo.methods[_853](this,_854);
}
}
_853=_853||{};
return this.each(function(){
var _856=$.data(this,"combogrid");
if(_856){
$.extend(_856.options,_853);
}else{
_856=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_853)});
}
_834(this);
});
};
...
return $.extend($.data(jq[0],"combogrid").options,{originalValue:_857.originalValue,disabled:_857.disabled,readonly:_857.readonly});
},grid:function(jq){
...
$.fn.combogrid.parseOptions=function(_85a){
var t=$(_85a);
return $.extend({},$.fn.combo.parseOptions(_85a),$.fn.datagrid.parseOptions(_85a),$.parser.parseOptions(_85a,["idField","textField","mode"]));
};
...
(function($){
function _85b(_85c){
var _85d=$.data(_85c,"datebox");
var opts=_85d.options;
$(_85c).addClass("datebox-f");
$(_85c).combo($.extend({},opts,{onShowPanel:function(){
_85d.calendar.calendar("resize");
opts.onShowPanel.call(_85c);
}}));
$(_85c).combo("textbox").parent().addClass("datebox");
if(!_85d.calendar){
_85e();
}
function _85e(){
var _85f=$(_85c).combo("panel");
_85d.calendar=$("<div></div>").appendTo(_85f).wrap("<div class=\"datebox-calendar-inner\"></div>");
_85d.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _860=opts.formatter(date);
_864(_85c,_860);
$(_85c).combo("hidePanel");
opts.onSelect.call(_85c,date);
}});
_864(_85c,opts.value);
var _861=$("<div class=\"datebox-button\"></div>").appendTo(_85f);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_861);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_861);
_861.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_861.find(".datebox-current").click(function(){
_85d.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_861.find(".datebox-close").click(function(){
$(_85c).combo("hidePanel");
});
};
};
function _862(_863,q){
_864(_863,q);
};
function _865(_866){
var opts=$.data(_866,"datebox").options;
var c=$.data(_866,"datebox").calendar;
var _867=opts.formatter(c.calendar("options").current);
_864(_866,_867);
$(_866).combo("hidePanel");
};
function _864(_868,_869){
var _86a=$.data(_868,"datebox");
var opts=_86a.options;
$(_868).combo("setValue",_869).combo("setText",_869);
_86a.calendar.calendar("moveTo",opts.parser(_869));
};
$.fn.datebox=function(_86b,_86c){
if(typeof _86b=="string"){
var _86d=$.fn.datebox.methods[_86b];
if(_86d){
return _86d(this,_86c);
}else{
return this.combo(_86b,_86c);
}
}
_86b=_86b||{};
return this.each(function(){
var _86e=$.data(this,"datebox");
if(_86e){
$.extend(_86e.options,_86b);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_86b)});
}
_85b(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _86f=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{originalValue:_86f.originalValue,disabled:_86f.disabled,readonly:_86f.readonly});
},calendar:function(jq){
return $.data(jq[0],"datebox").calendar;
},setValue:function(jq,_870){
return jq.each(function(){
_864(this,_870);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_871){
var t=$(_871);
return $.extend({},$.fn.combo.parseOptions(_871),{});
};
...
(function($){
function _872(_873){
var _874=$.data(_873,"datetimebox");
var opts=_874.options;
$(_873).datebox($.extend({},opts,{onShowPanel:function(){
var _875=$(_873).datetimebox("getValue");
_878(_873,_875,true);
opts.onShowPanel.call(_873);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_873).removeClass("datebox-f").addClass("datetimebox-f");
$(_873).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_873,date);
}});
var _876=$(_873).datebox("panel");
if(!_874.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_876.children("div.datebox-calendar-inner"));
_874.spinner=p.children("input");
var _877=_876.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_877);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
_874.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_878(_873,opts.value);
};
function _879(_87a){
var c=$(_87a).datetimebox("calendar");
var t=$(_87a).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _87b(_87c,q){
_878(_87c,q,true);
};
function _87d(_87e){
var opts=$.data(_87e,"datetimebox").options;
var date=_879(_87e);
_878(_87e,opts.formatter.call(_87e,date));
$(_87e).combo("hidePanel");
};
function _878(_87f,_880,_881){
var opts=$.data(_87f,"datetimebox").options;
$(_87f).combo("setValue",_880);
if(!_881){
if(_880){
var date=opts.parser.call(_87f,_880);
$(_87f).combo("setValue",opts.formatter.call(_87f,date));
$(_87f).combo("setText",opts.formatter.call(_87f,date));
}else{
$(_87f).combo("setText",_880);
}
}
var date=opts.parser.call(_87f,_880);
$(_87f).datetimebox("calendar").calendar("moveTo",date);
$(_87f).datetimebox("spinner").timespinner("setValue",_882(date));
function _882(date){
function _883(_884){
return (_884<10?"0":"")+_884;
};
var tt=[_883(date.getHours()),_883(date.getMinutes())];
if(opts.showSeconds){
tt.push(_883(date.getSeconds()));
}
return tt.join($(_87f).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_885,_886){
if(typeof _885=="string"){
var _887=$.fn.datetimebox.methods[_885];
if(_887){
return _887(this,_886);
}else{
return this.datebox(_885,_886);
}
}
_885=_885||{};
return this.each(function(){
var _888=$.data(this,"datetimebox");
if(_888){
$.extend(_888.options,_885);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_885)});
}
_872(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _889=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_889.originalValue,disabled:_889.disabled,readonly:_889.readonly});
},spinner:function(jq){
...
$.fn.datetimebox.parseOptions=function(_88b){
var t=$(_88b);
return $.extend({},$.fn.datebox.parseOptions(_88b),$.parser.parseOptions(_88b,["timeSeparator",{showSeconds:"boolean"}]));
};
...
function _88c(_88d){
return (_88d<10?"0":"")+_88d;
};
var _88e=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_88c(h)+_88e+_88c(M);
...
var _88f=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_88f);
var hour=parseInt(tt[0],10)||0;
var _890=parseInt(tt[1],10)||0;
var _891=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_890,_891);
}});
})(jQuery);
(function($){
function init(_892){
var _893=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_892);
var name=$(_892).hide().attr("name");
if(name){
_893.find("input.slider-value").attr("name",name);
$(_892).removeAttr("name").attr("sliderName",name);
}
return _893;
};
function _894(_895,_896){
var _897=$.data(_895,"slider");
var opts=_897.options;
var _898=_897.slider;
if(_896){
if(_896.width){
opts.width=_896.width;
}
if(_896.height){
opts.height=_896.height;
}
}
if(opts.mode=="h"){
_898.css("height","");
_898.children("div").css("height","");
if(!isNaN(opts.width)){
_898.width(opts.width);
}
}else{
_898.css("width","");
_898.children("div").css("width","");
if(!isNaN(opts.height)){
_898.height(opts.height);
_898.find("div.slider-rule").height(opts.height);
_898.find("div.slider-rulelabel").height(opts.height);
_898.find("div.slider-inner")._outerHeight(opts.height);
}
}
_899(_895);
};
function _89a(_89b){
var _89c=$.data(_89b,"slider");
var opts=_89c.options;
var _89d=_89c.slider;
...
_89e(aa);
function _89e(aa){
var rule=_89d.find("div.slider-rule");
var _89f=_89d.find("div.slider-rulelabel");
rule.empty();
_89f.empty();
for(var i=0;i<aa.length;i++){
var _8a0=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_8a0);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_89f);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_8a0,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_8a0,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
_8a4.removeClass("slider-h slider-v slider-disabled");
_8a4.addClass(opts.mode=="h"?"slider-h":"slider-v");
_8a4.addClass(opts.disabled?"slider-disabled":"");
_8a4.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _8a6=_8b7(_8a2,left);
_8a7(_8a6);
return false;
}
},onStartDrag:function(){
opts.onSlideStart.call(_8a2,opts.value);
},onStopDrag:function(e){
var _8a8=_8b7(_8a2,(opts.mode=="h"?e.data.left:e.data.top));
_8a7(_8a8);
opts.onSlideEnd.call(_8a2,opts.value);
}});
function _8a7(_8a9){
var s=Math.abs(_8a9%opts.step);
if(s<opts.step/2){
_8a9-=s;
}else{
_8a9=_8a9-s+opts.step;
}
_8aa(_8a2,_8a9);
};
};
function _8aa(_8ab,_8ac){
var _8ad=$.data(_8ab,"slider");
var opts=_8ad.options;
var _8ae=_8ad.slider;
var _8af=opts.value;
if(_8ac<opts.min){
_8ac=opts.min;
}
...
opts.value=_8ac;
$(_8ab).val(_8ac);
_8ae.find("input.slider-value").val(_8ac);
var pos=_8b0(_8ab,_8ac);
var tip=_8ae.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_8ab,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _8b1="left:"+pos+"px;";
_8ae.find(".slider-handle").attr("style",_8b1);
tip.attr("style",_8b1+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _8b1="top:"+pos+"px;";
_8ae.find(".slider-handle").attr("style",_8b1);
tip.attr("style",_8b1+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_8af!=_8ac){
...
function _899(_8b2){
var opts=$.data(_8b2,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_8aa(_8b2,opts.value);
opts.onChange=fn;
};
function _8b0(_8b3,_8b4){
var _8b5=$.data(_8b3,"slider");
var opts=_8b5.options;
var _8b6=_8b5.slider;
if(opts.mode=="h"){
var pos=(_8b4-opts.min)/(opts.max-opts.min)*_8b6.width();
if(opts.reversed){
pos=_8b6.width()-pos;
}
}else{
var pos=_8b6.height()-(_8b4-opts.min)/(opts.max-opts.min)*_8b6.height();
if(opts.reversed){
pos=_8b6.height()-pos;
}
}
...
function _8b7(_8b8,pos){
var _8b9=$.data(_8b8,"slider");
var opts=_8b9.options;
var _8ba=_8b9.slider;
if(opts.mode=="h"){
var _8bb=opts.min+(opts.max-opts.min)*(pos/_8ba.width());
}else{
var _8bb=opts.min+(opts.max-opts.min)*((_8ba.height()-pos)/_8ba.height());
}
return opts.reversed?opts.max-_8bb.toFixed(0):_8bb.toFixed(0);
};
$.fn.slider=function(_8bc,_8bd){
if(typeof _8bc=="string"){
return $.fn.slider.methods[_8bc](this,_8bd);
}
_8bc=_8bc||{};
return this.each(function(){
var _8be=$.data(this,"slider");
if(_8be){
$.extend(_8be.options,_8bc);
}else{
_8be=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_8bc),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_8c1){
var t=$(_8c1);
return $.extend({},$.parser.parseOptions(_8c1,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_8c2){
return _8c2;
},onChange:function(_8c3,_8c4){
},onSlideStart:function(_8c5){
},onSlideEnd:function(_8c6){
}};
})(jQuery);
