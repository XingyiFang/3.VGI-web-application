<?php
	...
	if ($number_type == "call"){
		$query = "SELECT confirmations from mod_data where report_id = 'obsnumber'";
		...
		$query_add = "UPDATE mod_data SET confirmations = confirmations + 1 WHERE report_id = 'obsnumber'";
